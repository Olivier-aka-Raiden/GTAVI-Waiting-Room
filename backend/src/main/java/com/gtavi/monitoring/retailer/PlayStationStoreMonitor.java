...
@ApplicationScoped
public class PlayStationStoreMonitor implements GameSourceMonitor {

    private static final String CODE = "PS_STORE";
    private static final String URL = "https://store.playstation.com/en-ch/search/grand%20theft%20auto%20vi";
    ...
    @Override public String sourceName() { return "PlayStation Store"; }
    ...
    public MonitorResult fetchCurrentState() {
        try {
            ...
            Log.errorf("PS Store monitor failed: %s", e.getMessage());
